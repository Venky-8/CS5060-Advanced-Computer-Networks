...
int main(int argc, char *argv[])
{
	...
	sendDataStr = "MSGTYPE: REGISTRN Videoserver video/audio 127.0.0.1 3491 abcd";
		...
		if (!fork()) { // this is the child process
			...
			*shared = *shared + 1;
			...
			if(extension == ".mp4" || extension == ".mp3") {
				...
				cout << "Enter filename of a video file ending with .mp4";
			}
